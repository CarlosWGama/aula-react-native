...
export function ItemTarefa (props: ItemTarefaProps) {
    return (
        <SwipeRow disableRightSwipe rightOpenValue={-140} stopRightSwipe={-140}>
        {/* OCULTA */}
...
const styles = StyleSheet.create({
    ...
    btn: { color: 'white' },
    btnEditar: {backgroundColor: 'blue', width:70, borderRadius: 0},
    btnExcluir: {backgroundColor: 'red', width:70, borderRadius: 0}
})